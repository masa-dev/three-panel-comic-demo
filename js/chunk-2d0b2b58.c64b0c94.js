 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function be(e,t){return t}class we{constructor(e,t,n,r){this.server=e,this.local=t||e,this.writable=!!n,this.xform=r||be}}let Re=null;function ke(e){return!j(e)||e.length<2?e:me(e)}function ve(){if(Re)return Re;const e=[];function t(e,t){return ke(t)}e.push(new we("bucket")),e.push(new we("generation")),e.push(new we("metageneration")),e.push(new we("name","fullPath",!0));const n=new we("name");function r(e,t){return void 0!==t?Number(t):t}n.xform=t,e.push(n);const s=new we("size");return s.xform=r,e.push(s),e.push(new we("timeCreated")),e.push(new we("updated")),e.push(new we("md5Hash",null,!0)),e.push(new we("cacheControl",null,!0)),e.push(new we("contentDisposition",null,!0)),e.push(new we("contentEncoding",null,!0)),e.push(new we("contentLanguage",null,!0)),e.push(new we("contentType",null,!0)),e.push(new we("metadata","customMetadata",!0)),Re=e,Re}function ye(e,t){function n(){const n=e["bucket"],r=e["fullPath"],s=new A(n,r);return t._makeStorageReference(s)}Object.defineProperty(e,"ref",{get:n})}function Te(e,t,n){const r={type:"file"},s=n.length;for(let o=0;o<s;o++){const e=n[o];r[e.local]=e.xform(r,t[e.server])}return ye(r,e),r}function xe(e,t,n){const r=pe(t);if(null===r)return null;const s=r;return Te(e,s,n)}function Ue(e,t,n,r){const s=pe(t);if(null===s)return null;if(!j(s["downloadTokens"]))return null;const o=s["downloadTokens"];if(0===o.length)return null;const i=encodeURIComponent,a=o.split(","),c=a.map(t=>{const s=e["bucket"],o=e["fullPath"],a="/b/"+i(s)+"/o/"+i(o),c=H(a,n,r),u=$({alt:"media",token:t});return c+u});return c[0]}function Oe(e,t){const n={},r=t.length;for(let s=0;s<r;s++){const r=t[s];r.writable&&(n[r.server]=e[r.local])}return JSON.stringify(n)}
/**
 * @license
...
//# sourceMappingURL=chunk-2d0b2b58.c64b0c94.js.map